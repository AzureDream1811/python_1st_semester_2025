    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_sessions', to=settings.AUTH_USER_MODEL, verbose_name='Người dùng')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('os', models.CharField(blank=True, max_length=100, verbose_name='Hệ điều hành')),
                ('location', models.CharField(blank=True, max_length=200, verbose_name='Vị trí')),
                ('status', models.CharField(choices=[('success', 'Thành công'), ('failed', 'Thất bại'), ('2fa_required', 'Yêu cầu 2FA')], default='success', max_length=20, verbose_name='Trạng thái')),
                ('provider', models.CharField(choices=[('email', 'Email/Password'), ('google', 'Google'), ('facebook', 'Facebook')], default='email', max_length=20, verbose_name='Phương thức')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, default='', max_length=15, validators=[django.core.validators.RegexValidator(message="Số điện thoại phải có định dạng: '0xxxxxxxxx' hoặc '+84xxxxxxxxx'", regex='^(0|\\+84)[0-9]{9,10}$')], verbose_name='Số điện thoại')),
                ('address', models.TextField(blank=True, default='', verbose_name='Địa chỉ chi tiết')),
                ('province', models.CharField(blank=True, default='', max_length=100, verbose_name='Tỉnh/Thành phố')),
                ('province_code', models.CharField(blank=True, default='', max_length=10, verbose_name='Mã tỉnh/thành phố')),
                ('district', models.CharField(blank=True, default='', max_length=100, verbose_name='Quận/Huyện')),
                ('district_code', models.CharField(blank=True, default='', max_length=10, verbose_name='Mã quận/huyện')),
